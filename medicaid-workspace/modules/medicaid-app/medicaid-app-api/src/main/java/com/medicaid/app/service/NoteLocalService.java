...
public interface NoteLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NoteLocalServiceUtil} to access the note local service. Add custom service methods to <code>com.medicaid.app.service.impl.NoteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
