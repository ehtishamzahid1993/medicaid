...
/**
 * Provides the local service interface for FacilityAdmin. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FacilityAdminLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FacilityAdminLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FacilityAdminLocalServiceUtil} to access the facility admin local service. Add custom service methods to <code>com.medicaid.app.service.impl.FacilityAdminLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
