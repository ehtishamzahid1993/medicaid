...
public interface DocumentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DocumentLocalServiceUtil} to access the document local service. Add custom service methods to <code>com.medicaid.app.service.impl.DocumentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
