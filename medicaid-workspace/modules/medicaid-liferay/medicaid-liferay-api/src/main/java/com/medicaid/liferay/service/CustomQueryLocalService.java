...
/**
 * Provides the local service interface for CustomQuery. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CustomQueryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CustomQueryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomQueryLocalServiceUtil} to access the custom query local service. Add custom service methods to <code>com.medicaid.liferay.service.impl.CustomQueryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
