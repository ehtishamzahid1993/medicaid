 ...
 * <code>com.medicaid.app.service.impl.DocumentLocalServiceImpl</code> and
...
public class DocumentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.medicaid.app.service.impl.DocumentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.medicaid.app.model.Document addDocument(
		com.medicaid.app.model.Document document) {
	 ...
	 */
	public static com.medicaid.app.model.Document createDocument(
		long documentId) {
	 ...
	 */
	public static com.medicaid.app.model.Document deleteDocument(
		com.medicaid.app.model.Document document) {
	...
	public static com.medicaid.app.model.Document fetchDocument(
		long documentId) {

		return getService().fetchDocument(documentId);
	}

	public static java.util.List<com.medicaid.app.model.Document>
	 ...
	 * @throws PortalException if a document with the primary key could not be found
	 */
	public static com.medicaid.app.model.Document getDocument(long documentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<com.medicaid.app.model.Document> getDocuments(
		int start, int end) {
	 ...
	 */
	public static com.medicaid.app.model.Document updateDocument(
		com.medicaid.app.model.Document document) {
