 ...
 * <code>com.medicaid.app.service.impl.PatientLocalServiceImpl</code> and
...
public class PatientLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.medicaid.app.service.impl.PatientLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.medicaid.app.model.Patient addPatient(
	 ...
	 */
	public static com.medicaid.app.model.Patient createPatient(long patientId) {
	 ...
	 */
	public static com.medicaid.app.model.Patient deletePatient(long patientId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 * @return the patient that was removed
	 */
	public static com.medicaid.app.model.Patient deletePatient(
		com.medicaid.app.model.Patient patient) {
	...
	public static com.medicaid.app.model.Patient fetchPatient(long patientId) {
		return getService().fetchPatient(patientId);
	}

	public static java.util.List<com.medicaid.app.model.Patient>
	 ...
	 * @throws PortalException if a patient with the primary key could not be found
	 */
	public static com.medicaid.app.model.Patient getPatient(long patientId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getPatient(patientId);
	}

	public static java.util.HashMap<Long, com.medicaid.app.model.Patient>
		getPatientMap() {

		return getService().getPatientMap();
	}
	 ...
	 */
	public static java.util.List<com.medicaid.app.model.Patient> getPatients(
		int start, int end) {
	 ...
	 */
	public static com.medicaid.app.model.Patient updatePatient(
		com.medicaid.app.model.Patient patient) {
	...
	private static ServiceTracker<PatientLocalService, PatientLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(PatientLocalService.class);

		ServiceTracker<PatientLocalService, PatientLocalService>
			serviceTracker =
				new ServiceTracker<PatientLocalService, PatientLocalService>(
					bundle.getBundleContext(), PatientLocalService.class, null);
